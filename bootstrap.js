...
function startup(data, reason) 
{
    ...
    Services.scriptloader.
        loadSubScript('chrome://personaswitcher/content/ui.js',
                      context,
                      "UTF-8" /* The script's encoding */);

    //https://blog.mozilla.org/addons/2014/03/06/australis-for-add-on-developers-2/
    //Loading the stylesheet into all windows is a noticable hit on performance 
    //but is necessary for Thunderbird compatibility
    styleSheetService = Cc["@mozilla.org/content/style-sheet-service;1"].
                            getService(Ci.nsIStyleSheetService);
    uri = Services.io.newURI("chrome://personaswitcher/skin/toolbar-button.css",
                           null, null);
